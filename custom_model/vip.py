...
__all__ = ["VisionPermutator", "vip_s14", "vip_s7", "vip_m7", "vip_l7"]
...
class WeightedPermuteMLP(nn.Module):
    def __init__(
        self, dim, segment_dim=8, qkv_bias=False, qk_scale=None, attn_drop=0.0, proj_drop=0.0
    ):
        super().__init__()
...
class PermutatorBlock(nn.Module):
    def __init__(
        ...
        self.attn = mlp_fn(
            dim, segment_dim=segment_dim, qkv_bias=qkv_bias, qk_scale=None, attn_drop=attn_drop
        )
...
@register_model
def vip_s14(pretrained=False, pretrained_cfg=None, **kwargs):
    layers = [4, 3, 8, 3]
    ...
    model.default_cfg["architecture"] = "vip_s14"
    return model


@register_model
def vip_s7(pretrained=False, pretrained_cfg=None, **kwargs):
    layers = [4, 3, 8, 3]
    ...
    model.default_cfg = default_cfgs["ViP_S"]
    model.default_cfg["architecture"] = "vip_s7"
    return model


@register_model
def vip_m7(pretrained=False, pretrained_cfg=None, **kwargs):
    layers = [4, 3, 14, 3]
    ...
    model.default_cfg["architecture"] = "vip_m7"
    return model


@register_model
def vip_l7(pretrained=False, pretrained_cfg=None, **kwargs):
    layers = [8, 8, 16, 4]
    transitions = [True, False, False, False]
    segment_dim = [32, 16, 16, 16]
    mlp_ratios = [3, 3, 3, 3]
    ...
    model.default_cfg["architecture"] = "vip_l7"
    return model
