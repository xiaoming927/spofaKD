...
__all__ = ["CycleNet", "CycleMLP_B1", "CycleMLP_B2", "CycleMLP_B3", "CycleMLP_B4", "CycleMLP_B5"]
...
class CycleFC(nn.Module):
    ...
    def __init__(
        ...
        self.weight = nn.Parameter(
            torch.empty(out_channels, in_channels // groups, 1, 1)
        )  # kernel size == 1
...
@register_model
def CycleMLP_B1(pretrained=False, pretrained_cfg=None, **kwargs):
    ...
    model.default_cfg["architecture"] = "CycleMLP_B1"
    return model


@register_model
def CycleMLP_B2(pretrained=False, pretrained_cfg=None, **kwargs):
    transitions = [True, True, True, True]
    layers = [2, 3, 10, 3]
    mlp_ratios = [4, 4, 4, 4]
    embed_dims = [64, 128, 320, 512]
    ...
    model.default_cfg = default_cfgs["cycle_S"]
    model.default_cfg["architecture"] = "CycleMLP_B2"
    return model


@register_model
def CycleMLP_B3(pretrained=False, pretrained_cfg=None, **kwargs):
    transitions = [True, True, True, True]
    layers = [3, 4, 18, 3]
    mlp_ratios = [8, 8, 4, 4]
    embed_dims = [64, 128, 320, 512]
    ...
    model.default_cfg["architecture"] = "CycleMLP_B3"
    return model


@register_model
def CycleMLP_B4(pretrained=False, pretrained_cfg=None, **kwargs):
    transitions = [True, True, True, True]
    layers = [3, 8, 27, 3]
    mlp_ratios = [8, 8, 4, 4]
    embed_dims = [64, 128, 320, 512]
    ...
    model.default_cfg["architecture"] = "CycleMLP_B4"
    return model


@register_model
def CycleMLP_B5(pretrained=False, pretrained_cfg=None, **kwargs):
    transitions = [True, True, True, True]
    layers = [3, 4, 24, 3]
    mlp_ratios = [4, 4, 4, 4]
    ...
    model.default_cfg = default_cfgs["cycle_L"]
    model.default_cfg["architecture"] = "CycleMLP_B5"
    return model
